...
DBM = {
	Revision = parseCurseDate("2025" .. "11" .. "02" .. "11" .. "00" .. "00"),
	DisplayVersion = GetAddOnMetadata(_addonname, "Version"), -- the string that is shown as version
	ReleaseRevision = releaseDate(2025, 11, 02, 11, 00, 00) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
}
